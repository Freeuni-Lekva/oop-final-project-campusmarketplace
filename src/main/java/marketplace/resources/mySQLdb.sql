...
# # -- Add posts
# # -- Post 1
# INSERT INTO posts (profile_id, title, price, description , publish_date)
# VALUES (1, 'test', 123.45, 'test test test', '2023-11-05');
# -- Post 2
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (2, 'Lenovo Flex 14 Touchscreen', 1450.00, 'Lenovo touchscreen laptop with 360° conversion. On the Ryzen 5 processor, with 12 gigabytes of RAM and the fastest Samsung M2 SSD.',  '2023-01-15');
# -- Post 3
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (2, 'iPhone 11 Pro Max 256/512GB', 1075.00, 'არის სრულიად ახალივით.იდეალურ მდგომარეობაში.',  '2023-02-20');
# -- Post 4
# INSERT INTO posts (profile_id, title, price, description,  publish_date)
# VALUES (3, 'მისაღები ოთახის კომპლექტი', 6500.00, 'სასწრაფოდ! იყიდება სულ ახალი მისაღების კომპლექტი რაც ხედავთ სურათზე ყველაფერი 6500. მაგიდას მოყვება 7 სკამი!', '2022-03-10');
# -- Post 5
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (4, 'Ibanez RG370DX, Indonesia 2008', 1500.00, 'ინდონეზიური Ibanez RG370DX. 15 წელია რაც ჩემს ხელშია. არის სრულად დასეტაპებული, ახალი სიმებით.', '2023-04-05');
# -- Post 6
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (5, 'ირლანდიური სეტერი', 200.00, 'სხვისდება ირლანდიური სეტერის ლეკვები, ძალიან კარგად მოვლილი და საუკეთესო ვიზუალის მქონე მშობლები საბუთებით, საგვარეულო ნუსხით.', '2023-05-20');
# -- Post 7
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (5, 'HUBLOT F1', 550.99, 'იყიდება მამაკაცის ელექტრონული საათი "HUBLOT -FORMULA 1" იაპონური მექანიზმით.',  '2023-05-20');
# -- Post 8
# INSERT INTO posts (profile_id, title, price, description, publish_date)
# VALUES (5, 'იყიდება ქართველი ავტორების წიგნები', 45.00, 'იყიდება ქართველი ავტორების წიგნები. წიგნები არის ნორმალურ მდგომარეობაში. სულ არის 10 წიგნი, იყიდება ყველა წიგნი ერთად, ფასი 45 ლარი.', '2023-05-20');
#
#
# # Add images
# -- Image 1
